...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public void load()
    {
        ...
        if(!inFile.equals(""))
        {
            // ID for gameObject and Component objects
            int maxGObjId = -1;
            int maxCmpId = -1;
            ...
            for(GameObject obj : GObjs)
            {
                ...
                for(Component cmp : obj.getAllComponents())
                {
                    if(cmp.getUid() > maxCmpId) {maxCmpId = cmp.getUid();}
                }

                if(obj.getUid() > maxGObjId) {maxGObjId = obj.getUid();}
